...
Public Class ListadoOrdenesRecibidas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ListadoOrdenesRecibidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tpi_pav_3k2.ListadoOrdenesRecibidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoOrdenesRecibidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoOrdenesRecibidas = New ListadoOrdenesRecibidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
